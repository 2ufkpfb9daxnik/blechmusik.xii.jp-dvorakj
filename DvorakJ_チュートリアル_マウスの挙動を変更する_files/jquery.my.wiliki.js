...
$(function() {
    $('h1').each(function() {
        var $this = $(this);
        var text = $this.find('a').text(); // <a>タグのテキストを取得
        $this.find('a').replaceWith(text); // <a>タグをテキストに置き換え
    });
});
...
/*
     FILE ARCHIVED ON 02:49:01 Mar 03, 2025 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 04:47:35 Jul 06, 2025.
...
playback timings (ms):
  ...
  esindex: 0.02
  cdx.remote: 6.282
  LoadShardBlock: 44.779 (3)
  PetaboxLoader3.datanode: 81.13 (5)
  load_resource: 230.93 (2)
  PetaboxLoader3.resolve: 149.496 (2)
*/